...
SECRET_KEY = 'django-insecure-rv7)w*us7in^@e++3d*k4xj2@m)8jv9_5^-ol((5_vv5c86njk'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Permet l'accès depuis n'importe quelle adresse (dev uniquement)
ALLOWED_HOSTS = ['*']

# Configuration CSRF pour accès mobile
